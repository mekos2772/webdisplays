...
public class S2CMessageJSResponse extends Packet {
    static { Packet.registerType(S2CMessageJSResponse.class, "js_response"); }
    public static final StreamCodec<FriendlyByteBuf, S2CMessageJSResponse> STREAM_CODEC = Packet.streamCodec(S2CMessageJSResponse::new);
