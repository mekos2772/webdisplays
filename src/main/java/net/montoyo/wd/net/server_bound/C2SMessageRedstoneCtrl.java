...
public class C2SMessageRedstoneCtrl extends Packet implements Runnable {
	static { Packet.registerType(C2SMessageRedstoneCtrl.class, "redstone_ctrl"); }
	public static final StreamCodec<FriendlyByteBuf, C2SMessageRedstoneCtrl> STREAM_CODEC = Packet.streamCodec(C2SMessageRedstoneCtrl::new);
